...
void PatternLayout::setConversionPattern(ConversionPattern conversionPattern)
{
  switch (conversionPattern) {
    ...
    case TTCC_CONVERSION_PATTERN:
      ...
      break;
    default:
      Q_ASSERT_X(false, "PatternLayout::setConversionFormat",
                 "Unkown ConversionFormat");
...
{
  Q_ASSERT_X(mpPatternFormatter, "PatternLayout::format()",
             "mpPatternConverter must not be null");
